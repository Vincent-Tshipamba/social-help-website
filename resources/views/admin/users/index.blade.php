...
@section('content')
    ...
    <div class="flex">
        <div class="w-full">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-100 leading-tight text-left">
                {{ __('Liste des utilisateurs de l\'interface d\'administration') }}
            </h2>
        </div>
        <!-- Modal toggle -->
    ...
    <div id="crud-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form action="{{ route('users.store') }}" class="p-4 md:p-5" method="POST">
                    @csrf
    ...
    <div class="py-6 relative overflow-x-auto">
        ...
        <table id="usersTable" class="p-5 w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
