        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title">
                    <h2>Nous offrons différents services pour vous aider dans votre foi</h2>
                    <p>Nous sommes dédiés à aider les gens à grandir dans leur foi et à trouver paix et réconfort dans
                        leur vie.</p>
                </div>
            </div>
        </div>
