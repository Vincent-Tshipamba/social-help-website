<!-- Features section -->
<section id="donates" class="bg-gray-100 py-20">
            ...
            @foreach ($aide_sociales as $key => $aide_sociale)
                <div class="w-full md:w-1/3 px-4 mb-8">
                    <div class="rounded-md bg-white shadow-md p-8">
                        ...
                        <p class="text-gray-600 mb-4">Date de lancement : {{ $aide_sociale->datelan }}</p>
                        <p class="text-gray-600 mb-4">Heure de lancement : {{ $aide_sociale->heure }}</p>
