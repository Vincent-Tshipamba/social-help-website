<section class="container px-3 py-12 bg-white md:px-0">
    <div class="flex flex-wrap items-center">
        <div class="w-full md:w-1/2 md:px-3">
            <div
                ...
                <h1
                    ...
                    <span class="block xl:inline">Avec amour, nous répondons</span>
                    <span class="block text-blue-600 xl:inline">aux appels du cœur.</span>
                </h1>
        ...
        <div class="w-full md:w-1/2 rounded-xl">
            <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                <img src="{{ asset('img/-170927-aide-social.png') }}" alt="" width="100%">
            </div>
        </div>
    </div>
</section>
